    ...
    <div class="col-12 playertable">
            <table>
                <?php
                    ...
                    echo '<th><a href="teams.php?sorting='.$sort.'&field=Player">Player</a></th>';
                    echo '<th><a href="teams.php?sorting='.$sort.'&field=Team">Team</a></th>';
                    echo '<th><a href="teams.php?sorting='.$sort.'&field=Age">Age</a></th>';
                    echo '<th><a href="teams.php?sorting='.$sort.'&field=GP">GP</a></th>';
                    echo '<th><a href="teams.php?sorting='.$sort.'&field=W">W</a></th>';
                    echo '<th><a href="teams.php?sorting='.$sort.'&field=L">L</a></th>';
                    echo '<th><a href="teams.php?sorting='.$sort.'&field=MIN">Min</a></th>';
                    echo '<th><a href="teams.php?sorting='.$sort.'&field=FGM">FGM</a></th>';
                    echo '<th><a href="team.php?sorting='.$sort.'&field=FGA">FGA</a></th>';
                    echo '<th><a href="team.php?sorting='.$sort.'&field=FG%">FG%</a></th>';
                    echo '<th><a href="team.php?sorting='.$sort.'&field=3PM">3PM</a></th>';
                    echo '<th><a href="team.php?sorting='.$sort.'&field=3PA">3PA</a></th>';
                    echo '<th><a href="team.php?sorting='.$sort.'&field=3P%">3P%</a></th>';
                    echo '<th><a href="team.php?sorting='.$sort.'&field=FTM">FTM</a></th>';
                    echo '<th><a href="team.php?sorting='.$sort.'&field=FTA">FTA</a></th>';
                    echo '<th><a href="team.php?sorting='.$sort.'&field=FT%">FT%</a></th>';
                    echo '<th><a href="teams.php?sorting='.$sort.'&field=REB">REB</a></th>';
                    echo '<th><a href="teams.php?sorting='.$sort.'&field=AST">AST</a></th>';
                    echo '<th><a href="teams.php?sorting='.$sort.'&field=TOV">TOV</a></th>';
                    echo '<th><a href="teams.php?sorting='.$sort.'&field=STL">STL</a></th>';
                    echo '<th><a href="teams.php?sorting='.$sort.'&field=BLK">BLK</a></th>';
                    echo '<th><a href="teams.php?sorting='.$sort.'&field=PTS">PTS</a></th>';
                    echo '<th><a href="teams.php?sorting='.$sort.'&field=DD2">DD2</a></th>';
                    echo '<th><a href="teams.php?sorting='.$sort.'&field=TD3">TD3</a></th>';
                    foreach($sql as $row){
                        echo "<tr><td>";
                        echo $row['Player'];
                        echo "</td><td>";
